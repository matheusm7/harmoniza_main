                  ...
                  children: [
                    ...
                    const SizedBox(
                      ...
                      child: Row(
                        ...
                        children: [
                          Icon(Icons.check),
                          Text(' Não renova automaticamente', style: TextStyle(color: Color.fromARGB(255, 101, 132, 98), fontWeight: FontWeight.w500)),
                        ],
                      ),
                    ),
                    const SizedBox(
                    ...
                    const SizedBox(
                      ...
                      child: Row(
                        ...
                        children: [
                          Icon(Icons.check),
                          Text('Garantia de 7 dias', style: TextStyle(color: Color.fromARGB(255, 101, 132, 98), fontWeight: FontWeight.w500)),
                          SizedBox(height: 5),
                        ],
                      ),
                    ),
